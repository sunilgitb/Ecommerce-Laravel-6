...
// Color Attributes
Route::get('admin/color', 'ColorController@index')->name('add.color');
Route::get('admin/color/manage_color', 'ColorController@manage_color');
Route::get('admin/color/manage_color/{id}', 'ColorController@manage_color');
Route::post('admin/color/manage_color_process', 'ColorController@manage_color_process')->name('color.manage_color_process');
Route::get('admin/color/delete/{id}', 'ColorController@delete');
